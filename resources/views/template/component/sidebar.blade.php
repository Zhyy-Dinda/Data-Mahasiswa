      ...
      <div class="navbar-content">
        ...
        <ul class="pc-navbar">
          ...
          <li class="pc-item pc-hasmenu">
            ...
            <ul class="pc-submenu">
              <li class="pc-item"><a class="pc-link" href="layout-vertical.html">Vertical</a></li>
              <li class="pc-item"><a class="pc-link" href="layout-horizontal.html">Horizontal</a></li>
              <li class="pc-item"><a class="pc-link" href="layout-compact.html">Compact</a></li>
              <li class="pc-item"><a class="pc-link" href="layout-tab.html">Tab</a></li>
            </ul>
          </li>
          <li class="pc-item pc-caption">
            <label>Widget</label>
